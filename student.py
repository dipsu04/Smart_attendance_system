...
class Student:
    def __init__(self, root):
        ...
        f_lbl2.place(x=900, y=0, width=530, height=130)
         ...
         # bg Image
        img3 = Image.open(r"/Users/deepkhanal/Desktop/smart attendance/images/sas1.jpg")
        ...
        img_left = Image.open(r"/Users/deepkhanal/Desktop/smart attendance/images/sas1.jpg")
        ...
        take_photo_btn.grid(row=0,column=4)
         ...
         #Update photo
        update_photo_btn=Button(btn_frame,text="Update Photo Sample",command=self.update_data,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"/Users/deepkhanal/Desktop/smart attendance/images/sas1.jpg")
            ...
            try:
             ...
             #file load gareko
                ...
                while True:
                    ...
                    if cv2.waitKey(50)==13 or int(img_id)==200:
                        break
                cap.release()
